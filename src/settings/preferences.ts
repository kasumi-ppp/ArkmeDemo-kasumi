...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.subtitle": "管理你的计划和待办",
    "arrangements.create": "新建安排",
    "arrangements.createTitle": "新建安排",
    "arrangements.titleLabel": "标题",
    "arrangements.titlePlaceholder": "例如：去医院、买菜、开会",
    "arrangements.noteLabel": "备注",
    "arrangements.notePlaceholder": "添加更多细节...",
    "arrangements.scheduledAtLabel": "计划时间",
    "arrangements.peopleLabel": "相关人物",
    "arrangements.peoplePlaceholder": "用逗号分隔，例如：张三,李四",
    "arrangements.locationLabel": "地点",
    "arrangements.locationPlaceholder": "例如：医院、家里、公司",
    "arrangements.pending": "待处理",
    "arrangements.snoozed": "以后再说",
    "arrangements.done": "已完成",
    "arrangements.snooze": "以后再说",
    "arrangements.delete": "删除",
    "arrangements.menu": "更多操作",
    "arrangements.toggleDone": "标记完成",
    "arrangements.closeModal": "关闭",
    "arrangements.emptyTitle": "还没有安排",
    "arrangements.emptyDesc": "点击右上角的 + 按钮创建第一个安排",
    "common.cancel": "取消",
  },
  "zh-TW": {
    "tabs.records": "快記",
    ...
    "arrangements.title": "安排",
    "arrangements.subtitle": "管理你的計劃和待辦事項",
    "arrangements.create": "新增安排",
    "arrangements.createTitle": "新增安排",
    "arrangements.titleLabel": "標題",
    "arrangements.titlePlaceholder": "例如：去醫院、買菜、開會",
    "arrangements.noteLabel": "備註",
    "arrangements.notePlaceholder": "添加更多細節...",
    "arrangements.scheduledAtLabel": "安排時間",
    "arrangements.peopleLabel": "相關人物",
    "arrangements.peoplePlaceholder": "逗號分隔，例如：小明、小紅",
    "arrangements.locationLabel": "地點",
    "arrangements.locationPlaceholder": "例如：醫院、家裡、辦公室",
    "arrangements.pending": "待辦",
    "arrangements.snoozed": "以後再說",
    "arrangements.done": "已完成",
    "arrangements.snooze": "以後再說",
    "arrangements.delete": "刪除",
    "arrangements.menu": "更多操作",
    "arrangements.toggleDone": "切換完成狀態",
    "arrangements.closeModal": "關閉",
    "arrangements.emptyTitle": "還沒有安排",
    "arrangements.emptyDesc": "點擊右上角的 + 按鈕創建第一個安排",
    "common.cancel": "取消",
  },
  "en-US": {
    "tabs.records": "Notes",
    ...
    "arrangements.subtitle": "Manage your plans and todos",
    "arrangements.create": "New arrangement",
    "arrangements.createTitle": "New arrangement",
    "arrangements.titleLabel": "Title",
    "arrangements.titlePlaceholder": "e.g.: Go to hospital, buy groceries, meeting",
    "arrangements.noteLabel": "Notes",
    "arrangements.notePlaceholder": "Add more details...",
    "arrangements.scheduledAtLabel": "Scheduled time",
    "arrangements.peopleLabel": "Related people",
    "arrangements.peoplePlaceholder": "Comma separated, e.g.: John, Mary",
    "arrangements.locationLabel": "Location",
    "arrangements.locationPlaceholder": "e.g.: Hospital, home, office",
    "arrangements.pending": "Pending",
    "arrangements.snoozed": "Later",
    "arrangements.done": "Done",
    "arrangements.snooze": "Later",
    "arrangements.delete": "Delete",
    "arrangements.menu": "More actions",
    "arrangements.toggleDone": "Toggle done",
    "arrangements.closeModal": "Close",
    "arrangements.emptyTitle": "No arrangements yet",
    "arrangements.emptyDesc": "Tap the + button in the top right to create your first arrangement",
